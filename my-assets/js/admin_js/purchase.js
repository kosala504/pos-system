      ...
      var  tab14 = 0;
        ...
        if (count == limits)  {
           ...
           newdiv = document.createElement("tr");
            ...
            '" class="form-control datepicker expiry_date_'+ count +'" placeholder="Expiry Date"/>  </td><td class="text-right"><input type="text" name="batch_no[]" required id="batch_no_'+ count +
            ...
            ' text-right" placeholder="0.00" value="" min="0" tabindex="'+tab12+'" readonly/><td class="text-right"><input class="form-control total_price text-right total_price_'+ count +
  ...
  // Counts and limit for purchase order
    ...
    function calculate_store(sl) {
      ...
      $("#total_vat_amnt").val(v.toFixed(2, 2)),
        ...
        var gttl = gr_tot - dis;
        var grandtotal = parseFloat(gttl);
