        ...
        <li
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?php echo (($this->uri->segment(1)=="product_list")?"active":'') ?>">
                 ...
                 <?php }?>
                <?php if($this->permission1->method('product_details','read')->access()){ ?>
                <li class="<?php echo (($this->uri->segment(1)=="product_details")?"active":'') ?>">
                    <a href="<?php echo base_url('product_li') ?>">

                        <?php echo display('product_details')?>
