            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-3 col-md-4 col-lg-3 col-xl-3">
                        ...
                        <div class="col-xs-8 col-sm-9 col-md-8 col-lg-9 col-xl-9 " id="style-3">
                        ...
                        <table class="table table-bordered table-hover table-sm nowrap gui-products-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <!--<th class="text-center"><?php echo "Total VAT" ?></th>-->
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="form-group col-md-6">
                                            <!--<div class="form-inline d-inline-flex align-items-center">-->
                                                <label
                                                    class=" "><?php echo display('paid_ammount') ?>:</label>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-xl-8">
                                    <div class="calculation d-lg-flex">
                                        <div class="cal-box d-lg-flex align-items-lg-center mr-4 col-md-4">
                                    <label for="4digit"
                                        class="col-form-label mr-2 mb-0"><?php echo display('paid_amount');?></label>

                                    <input type="text" id="pamount_by_method" class="form-control number pay "
                                        name="pamount_by_method[]" value="" onkeyup="changedueamount()" readonly="readonly"
                                        placeholder="0" />
                                ...
                                <!--    <div class="cal-box d-lg-flex align-items-lg-center mr-4 col-md-4">-->
                                <!--    <label for="4digit"-->
                                <!--        class="col-form-label pb-2"><?php echo display('paid_amount'); echo " : "?></label>-->
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <div class="col-lg-12 col-xl-12 text-xl-right">
